...
* If the change has a related GitHub issue (e.g. a bug fix for a reported issue), put a link to the issue as `[#123](https://github.com/rubocop/rubocop-performance/issues/123): `.
...
[1]: https://github.com/rubocop/rubocop-performance/issues
